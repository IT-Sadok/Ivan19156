...
namespace DeviceService.Rest.Hubs;

public class CommandHub : Hub
{
    private readonly IUnitOfWork _unitOfWork;

    public CommandHub(IUnitOfWork unitOfWork) => _unitOfWork = unitOfWork;
    ...
    public override async Task OnConnectedAsync()
    {
        ...
        if (Guid.TryParse(deviceIdStr, out var deviceId))
        {
            ...
            var pendingCommands = await _unitOfWork.DeviceCommands.GetPendingByDeviceIdAsync(deviceId, Context.ConnectionAborted);
