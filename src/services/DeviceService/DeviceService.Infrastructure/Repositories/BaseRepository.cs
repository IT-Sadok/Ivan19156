...
public abstract class BaseRepository<T> : IRepository<T> where T : class
{
    ...
    protected BaseRepository(DeviceDbContext context) => _context = context;
    ...
    public IQueryable<T> Filter(Expression<Func<T, bool>>? predicate = null, bool noTracking = false)
    {
